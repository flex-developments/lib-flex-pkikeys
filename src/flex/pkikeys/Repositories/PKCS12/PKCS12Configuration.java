 ...
 */
public class PKCS12Configuration extends AbstractRepositoryConfiguration {
    
    public PKCS12Configuration() {
        super();
    }
    
    public PKCS12Configuration(String path, String password) {
        setPath(path);
