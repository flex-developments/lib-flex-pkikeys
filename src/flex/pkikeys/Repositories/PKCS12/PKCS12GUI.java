...
/**
 * PKCS12GUI
 * Clase que permite capturar la ruta donde se ubica el archivo PKCS#12 del que
 * se cargarán las llaves y su respectiva contraseña, desde una interfáz gráfica
 * basada en Swing.
 * 
 * @author Ing. Felix D. Lopez M. - flex.developments@gmail.com
 * @author Ing. Yessica De Ascencao - yessicadeascencao@gmail.com
 */
public class PKCS12GUI extends javax.swing.JFrame {
    ...
    FileFilter filter = new FileFilter() {
        ...
        public String getDescription() {
            return PKCS12StringsBundle.get(PKCS12StringsBundle.I_PKCS12_FILTER_DESCRIPTION);
        }
    };
    ...
    private void initComponents() {
        ...
        lblImage = new javax.swing.JLabel(imagen);
        ...
        finder.setToolTipText(PKCS12StringsBundle.get("I_PKCS12_FILTER_TT"));

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle(PKCS12StringsBundle.get("I_PKCS12_TITLE"));
        ...
        lblPath.setText(PKCS12StringsBundle.get("I_PKCS12_L_PATH"));
        ...
        lblPass.setText(PKCS12StringsBundle.get("I_PKCS12_L_PASS"));

        txtPass.setFont(new java.awt.Font("DejaVu Sans", 0, 10)); // NOI18N
        txtPass.setToolTipText(PKCS12StringsBundle.get("I_PKCS12_TT_PASS"));
    ...
    private void btnFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindActionPerformed
        ...
        if (finder.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            String seleccted = finder.getSelectedFile().getAbsolutePath();
            setPath(seleccted);
     ...
     * Obtener Contraseña.
     * 
     * @return Retorna un String con la txtPass indicada en el texto.
     */
     ...
     * Obtener Ruta.
     *
     * @return Retorna un String con la txtPath de ubicación del archivo 
 PKCS#12 del que se cargarán las llaves.
     */
    ...
    public void errorMessage(String message) {
        JOptionPane.showOptionDialog(null,
                message,
                this.getTitle() + PKCS12StringsBundle.get(PKCS12StringsBundle.I_PKCS12_TITLE_SUFIX_ERROR),
    ...
    private int showModalWin() {
        return JOptionPane.showOptionDialog(null,
              ...
              null,
              new Object[] {
                  PKCS12StringsBundle.get(PKCS12StringsBundle.I_PKCS12_B_ACCEPT), 
                  PKCS12StringsBundle.get(PKCS12StringsBundle.I_PKCS12_B_CANCEL), 
                  PKCS12StringsBundle.get(PKCS12StringsBundle.I_PKCS12_B_CHANGE) 
              },
              null);
    }
            ...
            switch (showModalWin()) {
                case JOptionPane.OK_OPTION: { //Aceptar
                    ...
                    if (!f.exists() || f.isDirectory()) {
                        errorMessage(PKCS12StringsBundle.get(PKCS12StringsBundle.M_ERROR_PKCS12_NO_PATH));
                        txtPath.requestFocus();
                        throw new PKCS12Exception(null);

                    } else if(getPassword().isEmpty()) {
                        errorMessage(PKCS12StringsBundle.get(PKCS12StringsBundle.M_ERROR_PKCS12_EMPTY_PASS));
                        txtPass.requestFocus();
                        throw new PKCS12Exception(null);
                    }
                    break;
